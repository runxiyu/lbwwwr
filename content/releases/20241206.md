...
**[PLEASE READ THESE INSTRUCTIONS BEFORE INSTALLING](../install/ivy_has_common), OR
YOU MAY BRICK YOUR MACHINE!! - Please click the link and follow the instructions
there, before flashing. For posterity,
[here is the link again](../install/ivy_has_common).**
...
information available on the [U-Boot x86 page](../uboot/uboot-x86).
...
* **[Lenovo ThinkPad T480](../install/t480)** support, implemented by
...
* **[Lenovo ThinkPad T480S](../install/t480)** support, implemented by
  Mate Kukri with testing and hardware logs provided by Leah Rowe. - You can also
  [buy T480s with Libreboot pre-installed](https://minifree.org/product/libreboot-t480/)
* **[Dell OptiPlex 780 USFF](../install/dell780)** support, implemented
  by Nicholas Chin with testing and hardware logs provided by Lorenzo Aloe.
* **[Dell OptiPlex 780 MT](../install/dell780)** support, implemented by
