...
**[Libreboot 20241206 revision 8 announcement](libreboot20241206rev8)**

**[PLEASE READ THESE INSTRUCTIONS BEFORE INSTALLING](../docs/install/ivy_has_common), OR
YOU MAY BRICK YOUR MACHINE!! - Please click the link and follow the instructions
there, before flashing. For posterity,
[here is the link again](../docs/install/ivy_has_common).**
...
information available on the [U-Boot x86 page](../docs/uboot/uboot-x86).
...
* **[Lenovo ThinkPad T480](../docs/install/t480)** support, implemented by
...
* **[Lenovo ThinkPad T480S](../docs/install/t480)** support, implemented by
  Mate Kukri with testing and hardware logs provided by Leah Rowe. - You can also
  [buy T480s with Libreboot pre-installed](https://minifree.org/product/libreboot-t480/)
* **[Dell OptiPlex 780 USFF](../docs/install/dell780)** support, implemented
  by Nicholas Chin with testing and hardware logs provided by Lorenzo Aloe.
* **[Dell OptiPlex 780 MT](../docs/install/dell780)** support, implemented by
...
Please see: [Libreboot 20241206 release revisions](libreboot20241206.Revisions)
